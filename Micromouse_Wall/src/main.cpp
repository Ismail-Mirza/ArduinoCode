...
#define TRIGGER_PINL 12// Arduino pin tied to trigger pin on ping sensor.
#define ECHO_PINL 13    // Arduino pin tied to echo pin on ping sensor.
...
#define ECHO_PINR 10    // Arduino pin tied to echo pin on ping sensor.
